...
xml-tee | {
	...
	encode-triples-enrich-lobid-organisation(serialization="TURTLE",geonameFilename="geonames_DE.csv") |
	triples-to-rdfmodel(input="TURTLE")|
	write-rdfmodel(property="http://purl.org/dc/terms/identifier",endIndex="2",startIndex="0", fileSuffix="nt",serialization="N-TRIPLE",target="tmp")
}{
