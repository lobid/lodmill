...
This is early alpha work. The @lodmill-ld@ folder contains code for processing RDF with Hadoop and for indexing it in ElasticSearch. The @lodmill-ui@ folder contains a web app based on the Play framework that interacts with the resulting ElasticSearch index. The @lodmill-rd@ folder contains experimental work for working with raw data and its transformation to LOD.
